...
Flotr.defaultOptions = {
  ...
  plotOffsetOveride: null, // => Plot offset ovverride function. [NUTANIX Custom]
  xaxis: {
...
Graph.prototype = {
  ...
  calculateSpacing: function(){
    ...
    // Do we have an overide? Invoke it if so
    // [NUTANIX Custom]
    if ( this.options.plotOffsetOveride ) {
      this.options.plotOffsetOveride(this.plotOffset)
    }
